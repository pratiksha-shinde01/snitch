                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                        ...
                        {!isAddingVariant && (
                            <button
                                ...
                                className="bg-[#F97316] hover:bg-[#ea580c] active:bg-[#c2410c] text-white px-6 py-3 uppercase tracking-wider text-sm transition-colors duration-200 flex items-center gap-2 cursor-pointer"
                            >
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <button
                                            ...
                                            className="mt-3 text-[#FF8C00] text-sm uppercase tracking-wider flex items-center gap-1 hover:text-[#e67700] cursor-pointer"
                                        >
                          ...
                          cursor-pointer"
                            ...
                            <div className="mt-10 flex justify-end">
                                ...
                                <button
                                    ...
                                    className="bg-[#F97316] hover:bg-[#ea580c] active:bg-[#c2410c] text-white px-8 py-3 uppercase tracking-wider text-sm transition-colors duration-200 cursor-pointer"
                                >
                                    Save Variant
                                </button>
                            </div>
