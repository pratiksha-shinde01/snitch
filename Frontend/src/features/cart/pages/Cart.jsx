...
const Cart = () => {
  ...
  const { handleGetCart, handleIncrementCartItem, handleRemoveItem, handleDecrementItem } = useCart()
                        ...
                        <div className="flex items-center justify-between mt-auto pt-4 relative">
                          ...
                          <div className="flex items-center gap-4">
                            <button
                              onClick={() => {
                                changeQty(_id, -1)
                                if (handleDecrementItem) handleDecrementItem({ productId: product._id, variantId })
                              }}
